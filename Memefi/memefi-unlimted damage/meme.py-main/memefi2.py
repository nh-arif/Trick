...
def restart_program():
    print("❌ Error occurred. Restarting the program in 5 minutes...")
    for i in range(300, 0, -1):  # 300 seconds countdown
...
def activate_booster(index, headers):
    ...
    # Catch exception and restart the program after waiting 5 minutes
...
auto_claim_combo = 'n'  # Default to 'n' for Auto claim daily combo

# If needed, set a default combo
if auto_claim_combo == 'y':
    vector = '1,3,2,4,4,3,2,1'  # Default combo if auto claim combo is enabled
